...
if __name__ == '__main__':    
    ...
    selectnum = 0
    result_path = r'./Cam_result'
    atten_thresh=0.85

    # test = utils.listing(r'E:\Wayne\Code\IEA\Data\testing\zero','wav')
    # test = utils.auto_list(r'E:\Wayne\Code\IEA\Data\IEA_data\testing\zero',True);
    # test = utils.auto_list(r'E:\Wayne\Code\IEA\Data\VAD_data\training\nonspeech',True);       
...
# for old version grad_cam
    ...
    # out = utils.lps_rebuild(testdata, T_info[test_id]) 
    
    # img_lps,img_mask=save_as_img(T_lps,atten_bound)
